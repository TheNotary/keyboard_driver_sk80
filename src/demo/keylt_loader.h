...
//
// The demo deliberately does not link against keylt; it resolves the shared
...
int CallTurnOnKeyIdsD(char* key_ids, UINT8 n_keys, unsigned char* messages_sent, keylt::KeyboardInfo keyboard);
