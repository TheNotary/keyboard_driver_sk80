...
typedef int  (*TurnOnKeyNamesFunc)(const std::vector<std::string>& key_names, KeyboardInfo keyboard);
typedef int  (*TurnOffKeyNamesFunc)(const std::vector<std::string>& key_names, KeyboardInfo keyboard);
