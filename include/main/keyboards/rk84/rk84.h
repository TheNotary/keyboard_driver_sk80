...
class RK84 : public blink::AbstractKeyboard {
public:
    RK84()
        : blink::AbstractKeyboard(rk84::MESSAGE_LENGTH, rk84::BULK_LED_VALUE_MESSAGES_COUNT, rk84::target_device_path,
            DeviceInfo{ rk84::VID, rk84::PID }, rk84::keyname_keyid_mappings, rk84::max_key_id, nullptr)
    {}

    RK84(blink::Keyboard* keyboard_manager)
        : blink::AbstractKeyboard(rk84::MESSAGE_LENGTH, rk84::BULK_LED_VALUE_MESSAGES_COUNT, rk84::target_device_path,
...
private:
    ...
    blink::KeyValueBytesPair on_off_mappings = rk84::on_off_mappings;
