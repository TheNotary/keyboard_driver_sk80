...
class SK80 : public keylt::AbstractKeyboard {
public:
    SK80()
        : keylt::AbstractKeyboard(sk80::MESSAGE_LENGTH, sk80::BULK_LED_VALUE_MESSAGES_COUNT, sk80::target_device_path,
            DeviceInfo{ sk80::VID, sk80::PID }, sk80::keyname_keyid_mappings, sk80::max_key_id, nullptr)
    {}

    SK80(keylt::Keyboard* keyboard_manager)
...
private:
    keylt::KeyValueBytesPair on_off_mappings = sk80::on_off_mappings;
